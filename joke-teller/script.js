...
function tellMe(joke) {
    ...
    VoiceRSS.speech({
        key: '387dd3e41dcf4d7cb9e7ce2e2c9c6a0e',
        src: joke,
        hl: 'en-us',
        r: 0, 
        c: 'mp3',
...
async function getJokes() {
    let joke = '';
    const apiUrl = 'https://sv443.net/jokeapi/v2/joke/Miscellaneous?blacklistFlags=nsfw,religious,political,racist,sexist';
    try {
        ...
        // catch errors here
        console.log ('Whoops, You messed up here,', error);
    }
}
